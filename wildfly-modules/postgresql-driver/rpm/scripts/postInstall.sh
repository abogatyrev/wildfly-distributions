...
sudo /opt/wildfly/bin/jboss-cli.sh '--file=/tmp/postgresql-driver/cli/remove-postgresql-driver.cli'
fi

echo "Configuring PostgreSQL driver by CLI..."
sudo /opt/wildfly/bin/jboss-cli.sh '--file=/tmp/postgresql-driver/cli/configure-postgresql-driver.cli'